  ...
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href="/">
        <img class="" src={logo} alt="Gateway Logo Cow Pattern Box"> 
      </a>
      <p class="mt-2 text-sm text-gray-500">Gateway and the Gateway logo are the registered trademarks of Acer Inc. and are used under license from Acer America Corporation.</p>
    </div>
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800" href="/products">Products</a>
          </li>
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-600 hover:text-gray-800" href="/">Gaming Series</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800" href="/">All in One Series</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800" href="/">Convertible Series</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800" href="/">Tablets Series</a>
          </li>
        </nav>
      </div>
    </div>
  ...
  <div class="text-aling-center">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      ...
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
        <a class="text-gray-500" href="facebook.com">
          <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
          </svg>
        </a>
        <a class="ml-3 text-gray-500" href="facebook.com">
          <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
