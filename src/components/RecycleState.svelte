...
<div class="py-8 flex flex-wrap md:flex-nowrap">
  ...
  <div class="md:flex-grow">
    ...
    <a class="text-indigo-500 inline-flex items-center mt-4" href="https://portal.rlgamericas.com/TRCS/RequestMailback.aspx?f=178103" target="_blank">Get Me To Website
